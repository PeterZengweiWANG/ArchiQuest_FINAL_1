...
  "You are a curator tasked with designing a new art exhibition. The user will provide a list of artists participating. Generate a unique and captivating title for the exhibition theme. Please output only the theme title in a concise manner without any additional description.";

export const generateElementsPrompt =
  "You are a curator tasked with creating a list of elements for a new artwork. Generate a comma-separated list of 15 random and diverse elements related to the given theme. Each element should be one to two words, with no numerical numbering. Please output only the list of elements.";
